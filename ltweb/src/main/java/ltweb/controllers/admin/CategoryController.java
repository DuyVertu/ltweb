...
import static ltweb.utils.Constant.*;


@MultipartConfig(fileSizeThreshold = 1024 * 1024, maxFileSize = 1024 * 1024 * 5, maxRequestSize = 1024 * 1024 * 5 * 5)
@WebServlet(urlPatterns = { "/admin/categories", "/admin/cagetories/add", "/admin/cagetories/insert",
		"/admin/cagetories/edit", "/admin/cagetories/update", "/admin/cagetories/delete", "/admin/cagetories/search" })
